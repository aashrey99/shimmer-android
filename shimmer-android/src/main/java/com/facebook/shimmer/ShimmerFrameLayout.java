...
public class ShimmerFrameLayout extends FrameLayout {
  ...
  public ShimmerFrameLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (attrs != null) {
      ...
      try {
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_auto_start)) {
          setAutoStart(a.getBoolean(R.styleable.ShimmerFrameLayout_fbs_auto_start, false));
        }
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_base_alpha)) {
          setBaseAlpha(a.getFloat(R.styleable.ShimmerFrameLayout_fbs_base_alpha, 0));
        }
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_duration)) {
          setDuration(a.getInt(R.styleable.ShimmerFrameLayout_fbs_duration, 0));
        }
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_repeat_count)) {
          setRepeatCount(a.getInt(R.styleable.ShimmerFrameLayout_fbs_repeat_count, 0));
        }
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_repeat_delay)) {
          setRepeatDelay(a.getInt(R.styleable.ShimmerFrameLayout_fbs_repeat_delay, 0));
        }
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_repeat_mode)) {
          setRepeatMode(a.getInt(R.styleable.ShimmerFrameLayout_fbs_repeat_mode, 0));
        }

        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_angle)) {
          int angle = a.getInt(R.styleable.ShimmerFrameLayout_fbs_angle, 0);
          switch (angle) {
            default:
            case 0:
        ...
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_shape)) {
          int shape = a.getInt(R.styleable.ShimmerFrameLayout_fbs_shape, 0);
          switch (shape) {
            default:
            case 0:
        ...
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_dropoff)) {
          mMask.dropoff = a.getFloat(R.styleable.ShimmerFrameLayout_fbs_dropoff, 0);
        }
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_fixed_width)) {
          mMask.fixedWidth = a.getDimensionPixelSize(R.styleable.ShimmerFrameLayout_fbs_fixed_width, 0);
        }
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_fixed_height)) {
          mMask.fixedHeight = a.getDimensionPixelSize(R.styleable.ShimmerFrameLayout_fbs_fixed_height, 0);
        }
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_intensity)) {
          mMask.intensity = a.getFloat(R.styleable.ShimmerFrameLayout_fbs_intensity, 0);
        }
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_relative_width)) {
          mMask.relativeWidth = a.getFloat(R.styleable.ShimmerFrameLayout_fbs_relative_width, 0);
        }
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_relative_height)) {
          mMask.relativeHeight = a.getFloat(R.styleable.ShimmerFrameLayout_fbs_relative_height, 0);
        }
        if (a.hasValue(R.styleable.ShimmerFrameLayout_fbs_tilt)) {
          mMask.tilt = a.getFloat(R.styleable.ShimmerFrameLayout_fbs_tilt, 0);
        }
      } finally {
        a.recycle();
      }
